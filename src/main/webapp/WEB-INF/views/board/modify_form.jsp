...
<body>
	...
	<form action="${contextPath}/board/modify" enctype="multipart/form-data" method="post" >
		...
		<input type="hidden" name="originFileName" value="${dto.imageFileName}"> <!-- 원본 이미지 -->
		...
		<img width="200px" height="100px" id="preview" src="${contextPath}/board/download?imageFileName=${dto.imageFileName}">
